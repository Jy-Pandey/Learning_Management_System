...
const SearchResult = ({ course }) => {
  return (
    <div className="bg-white mb-4 p-4 flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 py-4 gap-4">
      <Link
      ...
      >
        <img
          ...
          className="h-34 w-full md:w-56 object-cover rounded"
        />
        <div className="flex flex-col gap-2">
          ...
          <Badge className="w-fit mt-3 md:mt-0">{course.courseLevel}</Badge>
        </div>
      </Link>
